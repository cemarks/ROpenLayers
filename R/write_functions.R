...
#' object (see \code{\link{ol_map}}) and call any REST APIs required for
#' each layer in order to 
...
#' \code{$head.script} \tab HTML script block sourcing the OpenLayers javascript library identify in \code{ol.map.obj}.\cr
